...
role :web, "crud_app3.com"                          # Your HTTP server, Apache/etc
role :app, "crud_app3.com"                         # This may be the same as your `Web` server
role :db,  "crud_app3.com"   , :primary => true # This is where Rails migrations will run
